<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Wanneer je je account verwijderd, worden alle opgeslagen gegevens permanent verwijderd. En dat is lang! Zorg ervoor dat je alle gegevens of informatie download die je graag wilt bewaren.') }}
        </p>
    </header>
